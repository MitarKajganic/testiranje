...
class ImpressionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create impression" do
    assert_difference("Impression.count") do
      post impressions_url, params: { impression: { client_id: @impression.client_id, comment: @impression.comment, date_impression: @impression.date_impression, time_impression: @impression.time_impression } }
    end
  ...
  test "should update impression" do
    patch impression_url(@impression), params: { impression: { client_id: @impression.client_id, comment: @impression.comment, date_impression: @impression.date_impression, time_impression: @impression.time_impression } }
