...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { price: @price.price, service_id: @price.service_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { price: @price.price, service_id: @price.service_id } }
